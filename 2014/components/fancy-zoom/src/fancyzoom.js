  ...
  $.fn.fancyZoom = function(options) {
    ...
    show = function(e) {
      ...
      if (window_size.width < width) {
        new_width = window_size.width - 20;
      ...
      // var positionFromCenter = 0 | options.positionFromCenter;
      // newTop = Math.max((window_size.height / 2) - (height / 2) + y, 10);
      newTop = Math.max((window_size.height / 4) + y, 10);
      ...
      var title = $(this).find('.event-name').text(),
